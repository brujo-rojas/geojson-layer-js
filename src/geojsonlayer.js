define([
  ...
  return declare([GraphicsLayer], {
    ...
    _createGraphic: function (arcgisJson) {
      ...
      }else if(arcgisJson.attributes.arcgis_style !== undefined){
        var s = new SimpleFillSymbol("solid",
            new SimpleLineSymbol("solid", new Color(arcgisJson.attributes.arcgis_style.lineColor), arcgisJson.attributes.arcgis_style.lineWidth),
            new Color(arcgisJson.attributes.arcgis_style.fillColor));
        graphic.setSymbol(s);
      } else {
